...
declare module "expo-router" {
  ...
  // prettier-ignore
  type StaticRoutes = `/` | `/(tabs)/discover` | `/discover` | `/(tabs)/feed` | `/feed` | `/(tabs)/profile` | `/profile` | `/(tabs)/search` | `/search` | `/(tabs)/tote` | `/tote` | `/components/Avatar` | `/components/ExternalLink` | `/components/StyledText` | `/components/Themed` | `/lib/types` | `/modal` | `/styles/globals`;
  // prettier-ignore
